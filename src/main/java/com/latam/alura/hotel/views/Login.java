...
public class Login extends JFrame {
	...
	public Login() {
		...
		btnLogin_1.setBackground(SystemColor.textHighlight);
		btnLogin_1.setBounds(219, 431, 189, 44);
		panel.add(btnLogin_1);

		JLabel lblRegistrarse = new JLabel("REGISTRAR");
		...
		lblRegistrarse.setForeground(SystemColor.controlLtHighlight);
		lblRegistrarse.setFont(new Font("Roboto", Font.PLAIN, 18));
		lblRegistrarse.setBounds(0, 0, 189, 44);
		btnLogin_1.add(lblRegistrarse);
	}
	...
	private void iniciarSesion() {
		...
		try {
			...
			Boolean concederAcceso = new UsuarioController().entrarAsistema(usuario, password);
			Usuario userActual = new UsuarioController().obtenerUsuario(usuario, password);
			if (concederAcceso) {
